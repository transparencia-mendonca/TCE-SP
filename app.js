...
function renderTravel(){
  ...
  $("#travelSec").innerHTML=`<div class="travel-hero card"><div class="travel-titleline"><h2>Diárias — triagem nominal</h2><span class="version-badge version-card">v0.9.14</span></div><p>Ranking do maior para o menor valor. A aba de salários foi retirada: remuneração ordinária deve ser consultada na folha de pagamento municipal.</p></div>
