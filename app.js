...
function auditExcludedSupplier(row){let t=normalizedName(row);return /FOLHA DE PAGAMENTO|PAGAMENTOS[- ]SERVIDORES|ENERGISA|TELEFONICA|TELECOM|CORREIOS|TRIVALE|ROM CARD|INSS|INSTITUTO NACIONAL DO SEGURO SOCIAL|CAIXA ECONOMICA|BANCO DO BRASIL|CAMARA MUNICIPAL|PREFEITURA MUNICIPAL|MUNICIPIO DE MENDONCA/.test(t)}
